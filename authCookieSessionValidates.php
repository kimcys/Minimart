...
// Check if loggedin session exists
else if (! empty($_COOKIE["cashier_login"]) && ! empty($_COOKIE["random_password"]) && ! empty($_COOKIE["random_selector"])) {
    ...
    $userToken = $auth->getTokenByUsername($_COOKIE["cashier_login"],0);
