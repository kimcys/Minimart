...
if (isset($_SESSION['success'])) {
  ...
  session_destroy();
  header('Location: supplierCash.php');
  return;
}
  if (isset($_POST['supplier_name']) && isset($_POST['supplier_email']) && isset($_POST['supplier_phoneno']) && isset($_POST['supplier_nobank'])) {
    $sql = "INSERT INTO supplier (supplier_name, supplier_email, supplier_phoneno, supplier_nobank)
               VALUES (:supplier_name, :supplier_email, :supplier_phoneno, :supplier_nobank)";
